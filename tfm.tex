...
%\usepackage{pdfpages}
\newcommand{\starL}{\ding{72}} % estrella
\newcommand{\rayo}{\lightning} % rayo
\newcommand{\reloj}{\faClockO}  % Definir el reloj de arena con wasysym
\newcommand{\monitor}{\faCog} % Definir el monitor con fontawesome
...
\input{capitulos/03_Desarrollo_del_TFM}
\input{capitulos/04_Resultados_y_Discusion}
...
%\appendix
%\input{anexos/diagramasSecuencia.tex}
%\input{anexos/innovacion.tex}
